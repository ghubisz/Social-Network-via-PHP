...
if ($profilehmlastid >= 1) {
    ...
    $getposts = mysql_query("SELECT * FROM posts WHERE user_posted_to ='$profilehm_uname' AND note='0' AND report='0' AND daowat_give='0' AND id < $profilehmlastid ORDER BY id DESC LIMIT 7") or die(mysql_error());
